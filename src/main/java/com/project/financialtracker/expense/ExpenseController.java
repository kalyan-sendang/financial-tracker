...
public class ExpenseController {
    ...
    public ResponseEntity<ResponseWrapper<Double>> getTotalCategoryAmount(@PathVariable Integer expenseCategoryId, HttpServletRequest request){
        ResponseWrapper<Double> response = new ResponseWrapper<>();
        try{
            Integer id = (Integer) request.getAttribute("userId");
            if(expenseService.getTotalCategoryAmount(id ,expenseCategoryId) == null) {
                response.setStatusCode(HttpStatus.OK.value());
                response.setSuccess(true);
                response.setMessage("Data retrieved Successfully");
                ...
                response.setSuccess(true);
                response.setMessage("Data retrieved Successfully");
                Double totalAmount = expenseService.getTotalCategoryAmount(id, expenseCategoryId);
                response.setResponse(totalAmount);
                return ResponseEntity.ok(response);
            }
        }catch(Exception e){
...
//    @GetMapping("/expense")
//    public ResponseEntity<ResponseWrapper<List<ExpenseDto>>> getAllExpense() {
//        ResponseWrapper<List<ExpenseDto>> response = new ResponseWrapper<>();
//        try {
//            if (expenseService.getAllExpensePerMonth(month, year) != null) {
//                response.setStatusCode(HttpStatus.OK.value());
//                response.setMessage("Expense retrieved successfully");
//                response.setSuccess(true);
//                response.setResponse(expenseService.getAllExpensePerMonth(month, year));
//                return ResponseEntity.ok(response);
//            } else {
//                response.setStatusCode(HttpStatus.NOT_FOUND.value());
//                response.setMessage("Expenses not found");
